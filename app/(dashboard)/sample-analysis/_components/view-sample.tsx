...
export default function ReusableSampleForm({
  ...
  const handlePrint = useReactToPrint({
    documentTitle: `Sample Analysis - ${formData.name}`,
  ...
  const documentDate = formData.created_at
  ...
  return (
    <div
      ref={componentRef}
      className="a4-paper mx-auto p-8 relative border my-3 bg-white"
    >
      ...
      <form onSubmit={handleSubmit} className="relative z-10">
        ...
        <div className="mt-6 text-center print:hidden">
          <button
            ...
            className="bg-primary text-white px-6 py-2 rounded  w-full cursor-pointer hover:bg-indigo-800"
          >
            {buttonText}
          </button>
        </div>
